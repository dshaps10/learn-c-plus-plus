...
This dialect of Pig Latin applies the following rules:
	...
	1) If the word contains no vowels, return the original word
	unchanged
	2) If the wrod beings with a consonant, extract the set 
	of consonants up to the first vowel, move the set
